package com.kuzmich.schoolbot.testutil;
...
/**
 * Утилита для создания объектов {@link Update} в тестах school-bot.
 * Вместо реальных конструкторов Telegram-классов использует Mockito-моки,
 * чтобы не ловить NPE из-за Lombok @NonNull внутри библиотеки.
 */
